...
const {sendOTP, checkPermission} = require('../utils')
...
module.exports = {getsingleUser, getAllUsers, showCurrentUser, updateUser, updateUserEmail, verifyOTP, updateUserPassword, deleteUser}